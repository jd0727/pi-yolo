...
def get_cdn_group(
    ...
    dn_bbox = gt_bbox.repeat(2 * num_group, 1).float() # 2*num_group*bs*num, 4
    ...
    if box_noise_scale > 0:
        ...
        dn_bbox = torch.logit(dn_bbox, eps=1e-6).float()  # inverse sigmoid
    ...
    #print(padding_bbox.dtype,dn_b_idx.dtype,map_indices.dtype,dn_bbox.dtype)
