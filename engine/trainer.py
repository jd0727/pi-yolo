...
class BaseTrainer:
    ...
    def _setup_train(self, world_size):
        ...
        if world_size > 1:
            self.model = self.model.to(torch.device('cuda:' + str(RANK)))
    ...
    def setup_model(self):
        ...
        self.model = self.get_model(cfg=cfg, weights=weights, verbose=RANK == -1)  # calls Model(models, weights)
        return ckpt
    ...
    def get_model(self, cfg=None, weights=None, verbose=True):
        """Get model and raise NotImplementedError for loading models files."""
        raise NotImplementedError("This task trainer doesn't support loading models files")
